...
const TabIcon = ({ source, label, focused }: { source: ImageSourcePropType; label: string; focused: boolean }) => {
        ...
        >
            ...
            <Tabs.Screen
                ...
                options={{
                    title: "Search",
                    headerShown: false,
                    tabBarIcon: ({ focused }) => <TabIcon source={icons.search} label="Search" focused={focused} />,
                }}
            />
            ...
            <Tabs.Screen
                ...
                options={{
                    title: "Saved",
                    headerShown: false,
                    tabBarIcon: ({ focused }) => <TabIcon source={icons.save} label="Saved" focused={focused} />,
                }}
            />
            ...
            <Tabs.Screen
                ...
                options={{
                    title: "Profile",
                    headerShown: false,
                    tabBarIcon: ({ focused }) => <TabIcon source={icons.person} label="Profile" focused={focused} />,
                }}
            />
        </Tabs>
    );
